...
public class GenericToolsTests {
    ...
    public @Test void testMathTool() {
        ...
        assertEquals(Double.valueOf(14.2),mathTool.roundTo(1,14.18));
        assertEquals(Double.valueOf(-5.0),mathTool.roundTo(2,-4.999));
        assertEquals(15,mathTool.sub(30,15));
        assertEquals(16, mathTool.pow(4, 2));
        assertEquals(Integer.valueOf(17),mathTool.toInteger("17"));
        assertEquals(Double.valueOf(18.1),mathTool.toDouble("18.1"));
    }
